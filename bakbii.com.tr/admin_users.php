...
$sql = "SELECT * FROM users $where_clause ORDER BY created_at DESC LIMIT $offset, $records_per_page";
...
<head>
    ...
    <title>Kullanıcı Yönetimi - Bakbii Emlak</title>
        ...
        <div class="row">
            ...
            <div class="col-md-9 col-lg-10 p-4">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    ...
                    <a href="admin_add_user.php" class="btn btn-success"><i class="bi bi-person-plus"></i> Yeni Kullanıcı Ekle</a>
                </div>
                ...
                <div class="card mb-4">
                    <div class="card-body">
                        <form action="" method="GET" class="row g-3">
                            ...
                            <?php if (!empty($search)): ?>
                                <div class="col-md-2">
                                    <a href="admin_users.php" class="btn btn-secondary">Filtreyi Temizle</a>
                                </div>
                            <?php endif; ?>
                        </form>
                    </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <?php if ($user['user_type'] !== 'admin' || $user['id'] != $_SESSION['user_id']): ?>
                                                        <a href="admin_users.php?delete_id=<?php echo $user['id']; ?>" class="btn btn-sm btn-danger" onclick="return confirm('Bu kullanıcıyı silmek istediğinizden emin misiniz?')"><i class="bi bi-trash"></i></a>
                                                    <?php endif; ?>
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
